...
# pragma implementation "addrDesc_amd64.hh"

# include "_addrDesc_amd64.cpp.incl"


# if  defined(FAST_COMPILER) || defined(SIC_COMPILER)

// On amd64, as on aarch64, relocatable referents (oops, send/DI targets,
// primitive addresses) are absolute 8-byte words in literal pools inside
// the code stream; pc-relative references are never recorded as addrDescs.
// This keeps GC updates and call-site patching simple atomic stores.
...
pc_t addrDesc::instr_referent(OopNCode* m) {
  ...
  assert(!isRelative(), "amd64 addrDescs hold absolute words");
  return *dispp;
}
